...
function loadmap(mapname,xxx,yyy,offx,offy)
	...
	--lg.setMode(640,360)
	ned = love.graphics.newImage("assets/images/ned1.png")
	polis = love.graphics.newImage("assets/images/polis.png")
end
...
function draw()
	...
	elseif gamemode == "gameplay" then	
		...
		love.graphics.draw(ned, protagX, protagY-playersize)
		...
		if firstkey == 0 then
			...
			love.graphics.printf(mapintro,0, gh-(gh/1), gw,"center")
			love.graphics.setFont( pixelfont )
			love.graphics.printf("press any key to continue",gw/2-50, gh/2+50, 100,"center")
		else
			...
			if dead==true then
				...
				love.graphics.printf("Booked",gw/2-50, bloodposy+50, 100,"center")
				love.graphics.setFont( pixelfontlarge )
				if bloodposy==0 then
